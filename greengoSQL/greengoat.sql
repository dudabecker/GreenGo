...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08-Jan-2023 às 00:22
...
INSERT INTO `especie` (`idEspecie`, `nomePop`, `nomeCie`, `descricao`, `imagem`, `frutifera`, `comestivel`, `raridade`, `medicinal`, `toxidade`, `exotica`, `pontoEsp`) VALUES
(1, 'Capim limão', 'Cymbopogon citratus', 'Erva-príncipe ou capim-cidreira também conhecido por capim-santo ou capim-limão, ou erva cidreira de capim é uma planta herbácea da família Poaceae, nativa das regiões tropicais da Ásia, especialmente da Índia.', '\"scr=GreenGo-main\\app\\public\\capim-limao.jpeg\"', 0, 0, 0, 0, 0, 0, 3),
(9, 'cacto', 'Cactaceae', 'Cactaceae é uma família botânica de arbustos, árvores, ervas, lianas e subarbustos representada pelos cactos ou catos. São aproximadamente 142 gêneros e 1793 espécies aceitas.', '\"scr=GreenGo-main\\app\\public\\cacto2.webp\"', 0, 0, 0, 0, 0, 0, 28);
...
INSERT INTO `zona` (`idZona`, `qntPlantas`, `pontoZona`) VALUES
(1, 10, 10);
...
--
ALTER TABLE `especie`
  MODIFY `idEspecie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `planta`
  MODIFY `idPlanta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
