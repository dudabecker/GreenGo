...
<body>
  <div class="container">
        ...
        <tbody>
          ...
          <?php foreach ($data['usuarios'] as $user): ?>
            ...
            <tr>
              ...
              <td>
                <a href='../controllers/UserController.php?action=findUserById&id=<?= $user->getId() ?>'> Mostrar
                  usuario</a>
              </td>

              <td>
                <a href='../controllers/UserController.php?action=edit&id=<?= $user->getId() ?>'> Editar </a>
              </td>
    ...
    <div class="row-3">
      <a class="salvar" href="./EspecieController.php?action=edit&idEspecie=<?= $especie['idEspecie'] ?>">Editar</a>
    </div>
  </div>
